...
const Header = () => {
    ...
    useEffect(()=>{
        console.log("istoken",getCookie('jswtoken'));
        setLogin(getCookie(' jswtoken'));
    },[]);
    ...
    const handleLogout = () => {
        document.cookie = "jswtoken=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;";
        ...
        <header class="bg-blue-500 text-white shadow-lg">
            <div class="container mx-auto px-4 py-3 flex items-center justify-between">
                ...
                <div class="flex items-center space-x-6">
                    {login ? <button class="text-white font-semibold" onClick={handleLogout}>Logout</button> : <Link to="/login"><button class="text-white font-semibold">Login</button></Link>}
                    <div class="relative">
